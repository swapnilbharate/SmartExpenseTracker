        ...
        <div className="d-flex align-items-center">
          {user ? (
            <>
              ...
              <Link
                className={`btn btn-sm px-3 py-2 rounded-3 me-2 fw-semibold ${
                  location.pathname === "/"
                    ? "btn-primary-custom"
                    : "btn-light text-dark"
                }`}
              ...
              <Link
                className={`btn btn-sm px-3 py-2 rounded-3 me-3 fw-semibold ${
            ...
            <button
              className="btn btn-sm btn-light border-0 rounded-3 p-2"
              onClick={() => setDark(!dark)}
              style={{
                width: "38px",
                height: "38px",
